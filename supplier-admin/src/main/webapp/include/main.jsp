...
<head>
    ...
    <!-- Morris -->
    <link href="${ctx}/resources/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    ...
    <link href="${ctx}/resources/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
...
<script src="${ctx}/resources/js/plugins/flot/jquery.flot.symbol.js"></script>
<script src="${ctx}/resources/js/plugins/peity/jquery.peity.min.js"></script>
<script src="${ctx}/resources/js/demo/peity-demo.min.js"></script>
...
<script src="${ctx}/resources/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${ctx}/resources/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="${ctx}/resources/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="${ctx}/resources/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="${ctx}/resources/js/demo/sparkline-demo.min.js"></script>
<script>
